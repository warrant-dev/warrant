...
func (repository PostgresRepository) CreateAll(ctx context.Context, contexts []ContextModel) ([]ContextModel, error) {
...
func (repository PostgresRepository) ListByWarrantId(ctx context.Context, warrantIds []int64) ([]ContextModel, error) {
